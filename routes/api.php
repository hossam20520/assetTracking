...
Route::get('/v1/device/asset', 'device\AssetsController@assetInfo');

Route::get('/v1/device/room', 'device\AssetsController@roomInfo');
...
Route::get('/v1/device/session/update', 'device\AssetsController@update_items');
Route::post('Items/import/csv', 'ItemsController@import_items');
Route::get('Items/barcode/{id}', 'device\AssetsController@barcode');
Route::post('Items/barcodeone', 'device\AssetsController@barcodeone');
Route::get('Item/assets/export/Excel/{date}', 'device\AssetsController@exportInventory');


Route::post('/v1/device/asset/image', 'device\AssetsController@updateImage');
...
Route::middleware(['auth:api', 'Is_Active'])->group(function () {
    ...
    //------------------------------- Inventores--------------------------\
    //------------------------------------------------------------------\
    Route::resource('inventores', 'InventoriesController');
    Route::post('inventores/delete/by_selection', 'InventoriesController@delete_by_selection');
    
    Route::get('inventores/data/{id}', 'InventoriesController@data');
    ...
    Route::post('groups/delete/by_selection', 'GroupsController@delete_by_selection');
    ...
    Route::post('builds/delete/by_selection', 'BuildsController@delete_by_selection');


    //------------------------------- Items--------------------------\
    //------------------------------------------------------------------\
    Route::resource('items', 'ItemsController');
    Route::post('items/delete/by_selection', 'ItemsController@delete_by_selection');
    
    //------------------------------- Rooms--------------------------\
    //------------------------------------------------------------------\
    Route::resource('rooms', 'RoomsController');
    Route::post('rooms/delete/by_selection', 'RoomsController@delete_by_selection');


       //------------------------------- Inventories--------------------------\
    //------------------------------------------------------------------\
    Route::resource('inventories', 'InventoriesController');
    Route::post('inventories/delete/by_selection', 'InventoriesController@delete_by_selection');


    Route::resource('Assets', 'AssetsController');
    Route::get('Assets/export/Excel', 'AssetsController@export_Excel');
    Route::post('Assets/import/csv', 'AssetsController@import_assets');
    Route::post('Assets/delete/by_selection', 'AssetsController@delete_by_selection');
    Route::get('Assets/Detail/{id}', 'AssetsController@Get_Assets_Details');

    Route::get('Assets/barcode/all', 'AssetsController@GetAllAssets');
 
    
    //------------------------------- Locations--------------------------\
    //------------------------------------------------------------------\
    Route::resource('locations', 'LocationsController');
    Route::post('locations/delete/by_selection', 'LocationsController@delete_by_selection');
