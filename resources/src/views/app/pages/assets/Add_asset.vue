...
<template>
  <div class="main-content">
    <breadcumb :page="$t('AddAsset')" :folder="$t('Assets')"/>
    <div v-if="isLoading" class="loading_page spinner spinner-primary mr-3"></div>

    <validation-observer ref="Create_Asset" v-if="!isLoading">
          ...
          <b-col md="8">
            ...
            <b-col md="6">
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider name="room_id" :rules="{ required: true}">
...
export default {
  ...
  methods: {
    ...
    Submit_Asset() {
      this.$refs.Create_Asset.validate().then(success => {
        if (!success) {
          this.makeToast(
            "danger",
