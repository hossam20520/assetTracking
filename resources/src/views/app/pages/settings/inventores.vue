      ...
      >
        ...
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'actions'">
            ...
            <b-button @click="Asset_Excel( props.row.start_session_date )" size="sm" variant="outline-danger m-1">
...
export default {
  ...
  methods: {
    ...
    Asset_Excel( date) {
      ...
      NProgress.set(0.1);
      axios
        .get("Item/assets/export/Excel/"+date, {
    ...
    Update_Inventore() {
      ...
      axios
        .post("inventores/" + self.inventore.id, self.data)
        .then(response => {
           self.SubmitProcessing = false;
          Fire.$emit("Event_Inventore");
