        ...
        children: [
            {
                ...
                component: () => import(/* webpackChunkName: "dashboard" */ "./views/app/dashboard/dashboard")
                           ...
                           {
                            path: "/app/assets",
                            component: () => import(/* webpackChunkName: "assets" */ "./views/app/pages/assets"),
                            ...
                            children: [
                                {
                                    ...
                                    path: "list",
                                    component: () =>
                                        import(/* webpackChunkName: "index_assets" */"./views/app/pages/assets/index_assets")
                                },
                                {
                                    path: "store",
                                    name: "store_asset",
                                    component: () =>
                                        import(/* webpackChunkName: "store_asset" */"./views/app/pages/assets/Add_asset")
                                },
                                {
                                    path: "edit/:id",
                                    name: "edit_asset",
                                    component: () =>
                                        import(/* webpackChunkName: "edit_asset" */"./views/app/pages/assets/Edit_asset")
                                },

                                {
                                    ...
                                    name: "detail_asset",
                                    component: () =>
                                        import(/* webpackChunkName: "detail_asset" */"./views/app/pages/assets/Detail_Asset")
                                }
         ...
         //numbers
         {
            ...
            children: [
                ...
                {
                    path: "barcodeone/:id/:type",
                    name: "oneBarcode",
                    component: () =>
                        import(/* webpackChunkName: "barcode" */"./views/app/pages/products/oneBarcode")
                },
            ...
            // Settings
            {
                ...
                children: [
                    ...
                    {
                    name: "inventorilist",
                    path: "inventorilist/:id",
                    component: () =>
                        import(/* webpackChunkName: "Brands" */"./views/app/pages/settings/inventory_data")
                     },
...

                    {
                        ...
                        path: "Inventores",
                        component: () =>
                            import(/* webpackChunkName: "Brands" */"./views/app/pages/settings/inventores")
                    },
                ...
                // groups
                {
                    ...
                    path: "Groups",
                    component: () =>
                        import(/* webpackChunkName: "Groups" */"./views/app/pages/settings/groups")
                },
                    ...
                    path: "Locations",
                    component: () =>
                        import(/* webpackChunkName: "Locations" */"./views/app/pages/settings/locations")
                   },
                    ...
                    name: "builds",
                    path: "Builds",
                    component: () => import(/* webpackChunkName: "Builds" */"./views/app/pages/settings/builds")
                    },
                    ...
                    // rooms
                    {
                        ...
                        path: "detail_room/:id",
                        component: () =>
                            import(/* webpackChunkName: "Rooms" */"./views/app/pages/settings/rooms")
                    },
                    ...
                    // items
                    {
                        ...
                        path: "detail_Item/:id",
                        component: () =>
                            import(/* webpackChunkName: "Items" */"./views/app/pages/settings/items")
                    },
